...
class SynapseProvider:
    ...
    def update_service(self, service_record_id: str, patch: Dict[str, Any]) -> Dict[str, Any]:
        return self._auth.update_provider_service(service_record_id, patch)

    def delete_service(self, service_record_id: str) -> Dict[str, Any]:
        return self._auth.delete_provider_service(service_record_id)

    def ping_service(self, service_record_id: str) -> Dict[str, Any]:
        return self._auth.ping_provider_service(service_record_id)

    def get_service_health_history(self, service_record_id: str, *, limit: int = 100) -> Dict[str, Any]:
    ...
    def get_withdrawal_capability(self) -> Dict[str, Any]:
    ...
    def list_withdrawals(self, *, limit: int = 100) -> Dict[str, Any]:
